...
# Call the HIDL makefile
$(call inherit-product, device/xiaomi/libra/hidl/hidl.mk)

# Call the Permissions makefile
$(call inherit-product, device/xiaomi/libra/permissions.mk)
